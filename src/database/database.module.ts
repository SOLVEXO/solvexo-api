...
@Module({
  imports: [
    ...
    MongooseModule.forFeature([
      ...
      { name: schema.SubscriptionCounter.name, schema: schema.SubscriptionCounterSchema },
      { name: schema.WebhookEvent.name, schema: schema.WebhookEventSchema },
      { name: schema.SubscriptionCreditWallet.name, schema: schema.SubscriptionCreditWalletSchema },
      { name: schema.SubscriptionNotificationPreference.name, schema: schema.SubscriptionNotificationPreferenceSchema },
      { name: schema.IdempotencyRecord.name, schema: schema.IdempotencyRecordSchema },
      { name: schema.PlatformPlan.name, schema: schema.PlatformPlanSchema },
      { name: schema.SellerPlatformSubscription.name, schema: schema.SellerPlatformSubscriptionSchema },
      { name: schema.PlatformPlanInvoice.name, schema: schema.PlatformPlanInvoiceSchema },
      { name: schema.PlatformPlanPaymentAttempt.name, schema: schema.PlatformPlanPaymentAttemptSchema },
      { name: schema.AiCreditsWallet.name, schema: schema.AiCreditsWalletSchema },
      { name: schema.PlatformAddonPurchase.name, schema: schema.PlatformAddonPurchaseSchema },
      ...
      { name: schema.AiCreditTransaction.name, schema: schema.AiCreditTransactionSchema },
    ]),
  ],
