...
@Module({
  imports: [
    ...
    MongooseModule.forFeature([
      ...
      { name: schema.BookableService.name, schema: schema.BookableServiceSchema },
      { name: schema.ServiceAvailability.name, schema: schema.ServiceAvailabilitySchema },
      { name: schema.ServicePackage.name, schema: schema.ServicePackageSchema },
      { name: schema.PackagePurchase.name, schema: schema.PackagePurchaseSchema },
      { name: schema.Booking.name, schema: schema.BookingSchema },
      ...
      { name: schema.Blog.name, schema: schema.BlogSchema },
      { name: schema.BlogComment.name, schema: schema.BlogCommentSchema },
