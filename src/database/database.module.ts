...
@Module({
  imports: [
    ...
    MongooseModule.forFeature([
      ...
      { name: schema.Supplier.name, schema: schema.SupplierSchema },
      { name: schema.PurchaseOrder.name, schema: schema.PurchaseOrderSchema },
      { name: schema.StockCount.name, schema: schema.StockCountSchema },
      ...
      { name: schema.Bin.name, schema: schema.BinSchema },
      { name: schema.StaffMember.name, schema: schema.StaffMemberSchema },
      { name: schema.Role.name, schema: schema.RoleSchema },
      { name: schema.ApprovalRequest.name, schema: schema.ApprovalRequestSchema },
      { name: schema.StockLot.name, schema: schema.StockLotSchema },
      { name: schema.StockUnit.name, schema: schema.StockUnitSchema },
