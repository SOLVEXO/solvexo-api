...
@Module({
  imports: [
    ...
    MongooseModule.forFeature([
      ...
      { name: schema.PlatformSeoSettings.name, schema: schema.PlatformSeoSettingsSchema },
      { name: schema.SeoRedirect.name, schema: schema.SeoRedirectSchema },
      { name: schema.SeoCanonicalRule.name, schema: schema.SeoCanonicalRuleSchema },
      { name: schema.SeoLandingPage.name, schema: schema.SeoLandingPageSchema },
      { name: schema.SeoSitemapCache.name, schema: schema.SeoSitemapCacheSchema },
      ...
      { name: schema.SeoIndexSnapshot.name, schema: schema.SeoIndexSnapshotSchema },
      { name: schema.SeoAnalyticsSnapshot.name, schema: schema.SeoAnalyticsSnapshotSchema },
      { name: schema.SeoCoreWebVitalsSnapshot.name, schema: schema.SeoCoreWebVitalsSnapshotSchema },
      { name: schema.SeoAiSuggestionLog.name, schema: schema.SeoAiSuggestionLogSchema },
      ...
      { name: schema.NotificationPreference.name, schema: schema.NotificationPreferenceSchema },
