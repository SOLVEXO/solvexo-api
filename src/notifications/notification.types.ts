...
export const NOTIFICATION_TYPES = {
  ...
  DRAFT_ORDER_INVOICE_OVERDUE: 'draft_order_invoice_overdue',
...
export const NOTIFICATION_CATEGORY: Record<string, 'orders' | 'messages' | 'promotions' | 'loyalty' | 'subscriptions' | 'finance'> = {
  ...
  [NOTIFICATION_TYPES.REFUND_ISSUED]: 'orders',
  [NOTIFICATION_TYPES.DISPUTE_OPENED]: 'finance',
  [NOTIFICATION_TYPES.DISPUTE_UPDATED]: 'finance',
  ...
  [NOTIFICATION_TYPES.PURCHASE_ORDER_OVERDUE]: 'orders',
  [NOTIFICATION_TYPES.DRAFT_ORDER_INVOICE_OVERDUE]: 'orders',
  [NOTIFICATION_TYPES.ORDER_PAYMENT_OVERDUE]: 'orders',
